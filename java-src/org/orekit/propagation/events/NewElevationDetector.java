 ...
 * @since 6.1
 */
public class NewElevationDetector extends AbstractDetector<NewElevationDetector> {
     ...
     */
    public NewElevationDetector(final TopocentricFrame topo) {
     ...
     * @see #withRefraction(AtmosphericRefractionModel)
     */
    public NewElevationDetector(final double maxCheck, final double threshold,
     ...
     * @param topo reference to a topocentric model
     */
    protected NewElevationDetector(final AdaptableInterval maxCheck, final double threshold,
    ...
    /** {@inheritDoc} */
    @Override
    protected NewElevationDetector create(final AdaptableInterval newMaxCheck, final double newThreshold,
                                       final int newMaxIter, final EventHandler newHandler) {
        return new NewElevationDetector(newMaxCheck, newThreshold, newMaxIter, newHandler,
     ...
     * @since 6.1
     */
    public NewElevationDetector withConstantElevation(final double newMinElevation) {
        return new NewElevationDetector(getMaxCheckInterval(), getThreshold(), getMaxIterationCount(), getHandler(),
     ...
     */
    public NewElevationDetector withElevationMask(final ElevationMask newElevationMask) {
        return new NewElevationDetector(getMaxCheckInterval(), getThreshold(), getMaxIterationCount(), getHandler(),
     ...
     */
    public NewElevationDetector withRefraction(final AtmosphericRefractionModel newRefractionModel) {
        return new NewElevationDetector(getMaxCheckInterval(), getThreshold(), getMaxIterationCount(), getHandler(),
